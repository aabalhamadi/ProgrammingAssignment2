## The below functions introduce a special matrix object which caches its inverse.
## To create a special matrix m you execute \code{m <- makeCacheMatrix(x)}
...
#' inverse from the cache.
#' 
#' @start x a special matrix created with makeCacheMatrix
#' 
